...
export class SandboxSbxAccount extends cdk.Stack {
  ...
  constructor(
    ...
    const management_account_id = new cdk.CfnParameter(this, "MgmtID", {
      type: "String",
      description: "MgmtID",
    });
    ...
    const TransitGatewayAttachmentSbx = new ec2.CfnTransitGatewayAttachment(
      ...
      "ISTransitGatewayAttachmentSbx",
      {
        ...
        tags: [
          {
            key: "Name",
            value: SbxAccountId+"IS-TG-Sbx-VPC-Private_SubNet-Attachment",
          },{
    ...
    const role = new iam.Role(this, "SandboxLoginRole", {
      assumedBy: new iam.AccountPrincipal(management_account_id.valueAsString),
