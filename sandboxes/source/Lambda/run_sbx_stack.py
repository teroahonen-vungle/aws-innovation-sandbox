...
def delete(event, context):
    ...
    try:
        delete_stack('SbxSBXStack', credentials)
...
def create(event, context):
    ...
    try:
        ...
        tags = {"Sandbox_Account_ID": sbx, "Eng_Team": tag_engteam }
        run_stack(sbx, tb+"SandboxSbxAccount.template", credentials_sbx, [
            {
                'ParameterKey': 'TgwID',
        ...
        tgw_sbx_details = get_transit_gateway_id_mgmt(credentials_sbx, sbx)
