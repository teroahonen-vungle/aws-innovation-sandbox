...
def validate_inputs(sbx_name, sbx_email, sbx_ou, client, root):
...
def create(event, context):
    ...
    sbx_id = props['Sbx_Id']
    sbx_ou_id = props['Sbx_OU_Id']

    

    
    try:
        logger.info("sbx_id: "+sbx_id)
        logger.info("sbx_ou_id: "+sbx_ou_id)
        if sbx_id == '-':
            ...
            validate_inputs(sbx_name, sbx_email, sbx_ou, organizations, root)
            ...
            responseData = {
                "Sandbox_Account_ID": sbx_id,
                "Sandbox_OU": sbx_ou_id
            }
