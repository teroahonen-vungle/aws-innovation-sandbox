...
mv $staging_dist_dir/Sandbox.template.json $staging_dist_dir/aws-sandbox.template.json
...
zip -r9 $staging_dist_dir/Lambda/Sandbox.zip .
cd $staging_dist_dir/Lambda
zip -r9 ./Sandbox.zip ./*.py
zip -r9 ./Sandbox.zip utils
...
cp -pr ./Sandbox.zip $build_dist_dir/
