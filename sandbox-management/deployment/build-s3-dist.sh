...
mv $staging_dist_dir/SandboxManagement.template.json $staging_dist_dir/aws-sandbox-management.template.json
...
zip -r9 $staging_dist_dir/Lambda/SandboxManagement.zip .
cd $staging_dist_dir/Lambda
zip -r9 ./SandboxManagement.zip ./*.py
zip -r9 ./SandboxManagement.zip utils

echo "Build lambda distribution packaging"
echo "Copy lambda distribution to $build_dist_dir"
cp -pr ./SandboxManagement.zip $build_dist_dir/
...
mv $template_dist_dir/SandboxManagementAccount.template $build_dist_dir
